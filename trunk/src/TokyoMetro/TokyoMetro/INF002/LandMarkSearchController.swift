...
class LandMarkSearchController: UIViewController, UITableViewDelegate, NSObjectProtocol, UIScrollViewDelegate, UITableViewDataSource, UIPickerViewDelegate, UIPickerViewDataSource{
    ...
    // 美食
    var landMarkSubType:String = "日系"
    var landMarkPrice:Int = 0
    var landMarkMiciRank:String = "0"
    var landMarkRank:String = "000"
    ...
    func buttonAction(sender: UIButton){
        ...
        case self.navigationItem.leftBarButtonItem!:
            ...
            case 1:
                lastController.landMarks = mstT04Table.queryLandMarksFilter("美食",lon: 0, lat: 0, distance: 0, sataId: landMarkStatId!, specialWard: landMarkSpecialWard!) as? Array<MstT04LandMarkTable>
            case 2:
