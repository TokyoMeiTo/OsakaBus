...
-(void)item:(NSString *)item value:(id)value{
    if([item isEqualToString:MSTT02_STAT_ID]){
        self.statId = value;
    }else if([item isEqualToString:MSTT02_STAT_GROUP_ID]){
        self.statGroupId = value;
    }else if([item isEqualToString:MSTT02_STAT_METRO_ID]){
        self.statNameMetroId = value;
    }else if([item isEqualToString:MSTT02_STAT_METRO_ID_FULL]){
        self.statNameMetroIdFull = value;
    }else if([item isEqualToString:MSTT02_STAT_NAME_EXT1]){
        self.statNameExt1 = value;
    }else if([item isEqualToString:MSTT02_STAT_NAME_EXT2]){
        self.statNameExt2 = value;
    }else if([item isEqualToString:MSTT02_STAT_NAME_EXT3]){
        self.statNameExt3 = value;
    }else if([item isEqualToString:MSTT02_STAT_NAME_EXT4]){
        self.statNameExt4 = value;
    }else if([item isEqualToString:MSTT02_STAT_NAME_EXT5]){
        self.statNameExt5 = value;
    }else if([item isEqualToString:MSTT02_STAT_NAME_EXT6]){
        self.statNameExt6 = value;
    }else if([item isEqualToString:MSTT02_STAT_NAME]){
        self.statName = value;
    }else if([item isEqualToString:MSTT02_STAT_NAME_KANA]){
        self.statNameKana = value;
    }else if([item isEqualToString:MSTT02_STAT_NAME_ROME]){
        self.statNameRome = value;
    }else if([item isEqualToString:MSTT02_STAT_LON]){
        self.statLon = value;
    }else if([item isEqualToString:MSTT02_STAT_LAT]){
        self.statLat = value;
    }else if([item isEqualToString:MSTT02_STAT_PREF]){
        self.statPref = value;
    }else if([item isEqualToString:MSTT02_STAT_ADDR]){
        self.statAddr = value;
    }else if([item isEqualToString:MSTT02_STAT_DESP]){
        self.statDesp = value;
    }else if([item isEqualToString:MSTT02_LINE_ID]){
        self.lineId = value;
    }else if([item isEqualToString:MSTT02_STAT_SEQ]){
        self.statSeq = value;
    }else{
