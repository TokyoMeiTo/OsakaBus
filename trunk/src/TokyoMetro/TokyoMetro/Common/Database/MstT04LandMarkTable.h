...
#define MSTT04_LANDMARK_LMAK_TYPE           @"LMAK_NAME_TYPE"
#define MSTT04_LANDMARK_LMAK_SUB_TYPE       @"LMAK_NAME_SUB_TYPE"
...
#define MSTT04_LANDMARK_LMAK_TICL_PRIC      @"LMAK_TICL_PRIC"
